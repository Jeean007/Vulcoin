Contributing to Vulcoin Core
==================================

The Vulcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vulcoin Core project, and is not to be
confused with overall Vulcoin Network Protocol consensus changes.

Whether a pull request is merged into Vulcoin Core rests with the project merge
...
Patches that change Vulcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vulcoin consensus, it must have been
...
The project leader is the release manager for each Vulcoin Core release.
