...
/**
 * Vulcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue gethashespervlc(const UniValue& params, bool fHelp);
...
extern UniValue walletpassphravlchange(const UniValue& params, bool fHelp);
