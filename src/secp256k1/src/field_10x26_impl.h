...
#ifndef _VLCP256K1_FIELD_REPR_IMPL_H_
#define _VLCP256K1_FIELD_REPR_IMPL_H_
...
VLCP256K1_INLINE static void secp256k1_fe_clear(secp256k1_fe_t *a) {
#ifdef VERIFY
    a->magnitude = 0;
    a->normalized = 1;
#endif
...
VLCP256K1_INLINE static void secp256k1_fe_mul_inner(const uint32_t *a, const uint32_t * VLCP256K1_RESTRICT b, uint32_t *r) {
    VERIFY_BITS(a[0], 30);
    VERIFY_BITS(a[1], 30);
    VERIFY_BITS(a[2], 30);
    VERIFY_BITS(a[3], 30);
...
VLCP256K1_INLINE static void secp256k1_fe_sqr_inner(const uint32_t *a, uint32_t *r) {
    VERIFY_BITS(a[0], 30);
    VERIFY_BITS(a[1], 30);
    VERIFY_BITS(a[2], 30);
    VERIFY_BITS(a[3], 30);
