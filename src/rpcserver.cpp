...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"generating", "gethashespervlc", &gethashespervlc, true, false, false},
        ...
        {"wallet", "walletpassphravlchange", &walletpassphravlchange, true, false, true},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22031/\n";
}
