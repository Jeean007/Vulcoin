...
/* Vulcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Vulcoin"
#define QAPP_ORG_DOMAIN "vulcoincoin.io"
#define QAPP_APP_NAME_DEFAULT "Vulcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Vulcoin-Qt-testnet"
