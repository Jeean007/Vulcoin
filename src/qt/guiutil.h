...
/** Utility functions used by the Vulcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render VLC addresses in monospace font
...
// Parse "vulcoin:" URI into recipient object, return true on successful parsing
