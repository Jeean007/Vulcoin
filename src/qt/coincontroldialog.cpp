...
QString CoinControlDialog::getPriorityLabel(double dPriority)
{
    ...
    {
        if      (dPriority > 5760000000ULL)   return tr("VLCest");
        else if (dPriority > 576000000ULL)    return tr("VLC");
        else if (dPriority > 57600000ULL)     return tr("medium-VLC");
