...
2. [Sending 1,000 Vulcoin to new wallet addresses.](#option2)
...
Copy the masternode private key and correspondig collateral output transaction that holds the 2,500 VLC.
...
```
mn01 127.0.0.1:22300 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0
mn02 127.0.0.2:22300 93WaAb3htPJEV8E9aQcN23Jt97bPex7YvWfgMDTUdWJvzmrMqey aa9f1034d973377a5e733272c3d0eced1de22555ad45d6b24abadff8087948d4 0 7gnwGHt17heGpG9Crfeh4KGpYNFugPhJdh:25
```

## What about the vulcoin.conf file?

If you are using a masternode.conf file you no longer need the vulcoin.conf file. The exception is if you need custom settings (thanks oblox).

## Update vulcoin.conf on server

If you generated a new masternode private key, you will need to update the remote vulcoin.conf files.

Shut down the daemon and then edit the file.

```sudo nano .vulcoin/vulcoin.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote vulcoin.conf file.
