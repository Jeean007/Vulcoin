...
* Update translations see [translation_process.md](https://github.com/VulcoinFoundation/VulcoinCoin/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/VulcoinFoundation/VulcoinCoin-detached-sigs.git
...
- Detached signatures will then be committed to the [vulcoin-detached-sigs](https://github.com/VulcoinFoundation/VulcoinCoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the vulcoincoin.io server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/VulcoinFoundation/VulcoinCoin/releases/new) with a link to the archived release notes.
