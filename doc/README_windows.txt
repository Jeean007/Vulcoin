...
Intro
-----
Vulcoin (VLC) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. Vulcoin utilizes an energy efficient proof-of-stake algorithm,
can be mined on any computer, and will never require specialized mining equipment.

Setup
-----
Unpack the files into a directory and run vulcoin-qt.exe.

Vulcoin Core is the original Vulcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Vulcoin transactions;
