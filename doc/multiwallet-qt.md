...
In order to support loading of multiple wallets in vulcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vulcoin.cpp.
...
Changes to vulcoin.cpp
----------------------
vulcoin.cpp is the entry point into vulcoin-qt, and as such, will require some minor modifications to provide hooks for
