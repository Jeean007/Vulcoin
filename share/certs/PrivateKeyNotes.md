...
Gavin is a single point of failure. He could be coerced to divulge the vlcret signing keys,
...
non-technical users vlcurely get the gitian downloader code to start?"
